...
class CheckoutFlowTest {
    ...
    @Autowired
    private io.github.semandrics.shop.catalog.application.CatalogService catalogService;

    @Test
    void shouldCompleteCheckoutSuccessfully() {
        // Arrange
        var sku = "PROD-1";
        catalogService.defineProduct(new Product(sku, "Test Product", new BigDecimal("100.00")));
    ...
    void shouldFailCheckoutWhenStockInsufficient() {
        ...
        catalogService.defineProduct(new Product(sku, "No Stock Product", new BigDecimal("50.00")));
