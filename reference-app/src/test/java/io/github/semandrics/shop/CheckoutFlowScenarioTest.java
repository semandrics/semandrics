...
public class CheckoutFlowScenarioTest {
    ...
    void shouldCompleteCheckoutSuccessfully_usingScenario() {
        ...
        var cartId = new CartId(UUID.fromString("a664bd82-9b4f-48ed-a567-b334f8715698"));
        var orderId = new OrderId(UUID.fromString("288d3df1-e958-4a38-aa7d-f52291365929"));
